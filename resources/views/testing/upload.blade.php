...
<div id="appCapsule">
    ...
    <div class="modal fade dialogbox" id="modalDelete" data-bs-backdrop="static" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="action-button-list">
                            ...
                            <li>
                                <a href="#" class="btn btn-list" data-bs-toggle="modal" data-bs-target="#modalDelete" data-bs-dismiss="modal">
                                    <span>
